<header>
    <div class="flex justify-between px-8 py-2 bg-gray-50 text-sm">
        <div>
            <a href="" class="text-black hover:text-primary flex items-center gap-2">
        ...
        @if (Auth::check())
            @if (Auth::user()->merchant == null)
                <div class="flex items-center gap-4 h-8">
                    ...
                    <a href="" class="text-black hover:text-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            @if (Auth::user()->merchant != null)
                <div class="flex items-center gap-2">
                    <img src="{{ asset(Auth::user()->merchant->image) }}" alt="" class="w-8 h-8 rounded-full">
                    <p class="text-black">DK Store</p>
                </div>
            @endif
